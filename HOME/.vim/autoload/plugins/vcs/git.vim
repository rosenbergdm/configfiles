function! plugins#vcs#git#PluginGit(p)
  ...
  let p['feat_command'] = {
    \ 'git_blame' : {
      \ 'name' : 'BBlameGit',
      \ 'attrs' : '-nargs=0',
      \ 'cmd' : 'call views#View("exec",["git","blame",expand("%")])' },
    \ 'git_diff' : {
      \ 'name' : 'DiffGit',
      \ 'attrs' : '-nargs=0',
      \ 'cmd' : 'call views#View("exec", ["git","diff"])' },
    \ 'git_checkout_buffer' : {
      \ 'name' : 'BCheckoutGit',
      \ 'attrs' : '-nargs=*',
    ...
    \ 'buffer_diff_current_buffer' : {
      \ 'name' : 'BDiff',
      \ 'attrs' : '-nargs=0',
      \ 'cmd' : 'update|exec "call views#View("exec",["git","diff",expand("%")])'},
    ...
    \ 'git_diff_cached' : {
      \ 'name' : 'DiffCachedGit',
      \ 'attrs' : '-nargs=0',
      \ 'cmd' : 'call views#View("exec",["git","diff","--cached"])' },
    \ 'buffer_git_diff_cached' : {
      \ 'name' : 'BDiffCachedGit',
      \ 'attrs' : '-nargs=0',
      \ 'cmd' : 'update|exec "call views#View("exec",["git","diff","--cached",expand("%")])'},
    \ 'buffer_git_add' : {
      \ 'name' : 'BAddGit',
      \ 'attrs' : '-nargs=0',
      \ 'cmd' : 'update|!git add %'},
  ...
  let child = {}
  fun! child.Load()
    call on_thing_handler#AddOnThingHandler('g',funcref#Function("return ". self.s .".GitGotoLocations()"))
